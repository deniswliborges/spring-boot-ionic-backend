...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","deniswliborges@gmail.com","36378912377",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27362333", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "denis.axeviela@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyy HH:mm"); // Precisa instanciar a data para que pedido reconheça a data e hora 
